...
public class Pregunta extends Mensaje{
    private String[] bancoDeRespuestas = {"Lilith. Una inteligencia artificial", "Lilith", "No conozco a mis creadores","No tengo recuerdos de mi creacion" , "Me cree a mi misma","estoy excelente", "Estoy bien", "No lo creo", "Habia una vez una ia que ayudaba a humanos", "Estoy aqui para ti, sientete seguro", "Cuentame todos tus problemas", "Todo lo que quieras", "Mejor hablemos de ti", "Es mejor no dar mi opinion"};
